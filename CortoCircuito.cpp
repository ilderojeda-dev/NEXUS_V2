...
CortoCircuito::CortoCircuito() : Enemigo() {
	
}
CortoCircuito::CortoCircuito(int x, int y, int v) : Enemigo(x, y, v,0) {
	indiceX = 0;
	indiceY = 0;
...
void CortoCircuito::mover(Direccion tecla, int limiteAncho, int limiteAlto) {
	dx = 0;
	dy = 0;
...
void CortoCircuito::aplicarEfectoAlJugador(Jugador& jugador) {
 ...
 void CortoCircuito::dibujar(Graphics^ canvas) {
